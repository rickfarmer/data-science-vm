...
echo "Installing Hadoop MRv1 in pseudo-distributed mode..."
# Install Hadoop MRv1 in pseudo-distributed mode use,
...
echo "Starting MRv1 services..."
for x in `cd /etc/init.d; ls hadoop-0.20-mapreduce-*`; do sudo service $x start; done

# Verify JobTracker is running jobs at http://localhost:50070/
